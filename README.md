...
<a onclick="brower.bookmarks.create({title:'테스트',url:      `javascript:(()=>{fetch('https:\/\/joh1ah.github.io/dclivechat/min.js').then(res=>res.text().then(text=>eval(text))).catch(()=>alert('error'))})();})`>북마크에 추가</a>
